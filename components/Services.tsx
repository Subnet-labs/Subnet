      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
          <div className="max-w-xl">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">Built for <span className="text-emerald-500">Growth</span>.</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((s, idx) => (
            <div key={idx} className="group relative glass-card p-10 rounded-[3rem] overflow-hidden hover:border-white/20 transition-all hover:-translate-y-2 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <button className="flex items-center gap-2 text-sm font-bold text-white group-hover:text-emerald-400 transition-colors cursor-pointer focus:outline-none focus:text-emerald-400">
                  Learn more
