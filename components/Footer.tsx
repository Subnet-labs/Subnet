...
const Footer: React.FC = () => {
  return (
    <footer className="pt-32 pb-12 px-6 border-t border-white/5 relative bg-black">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 font-medium">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Process</a></li>
      ...
      {/* Back to top glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-px bg-gradient-to-r from-transparent via-emerald-500/50 to-transparent" />
    </footer>
  );
};
